...
class WP_Fields_API_Field {
	...
	/**
	 * Whether a field is for internal (WP Core) use
	 *
	 * @access public
	 * @var bool
	 */
	...
	/**
	 * Capability required for the field.
	 *
	 * @access public
	 * @var string|array
	 */
	...
	/**
	 * Constructor. Any supplied $args override class property defaults.
	 *
	 * @param string $object_type   Object type.
	 * @param string $id            A specific ID of the field.
	...
	public function sanitize( $value ) {
		...
		/**
		 * Filter a field value in un-slashed format.
		 *
	 ...
	 *
	 * @return bool False if theme doesn't support the field or user can't change field, otherwise true.
	 */
